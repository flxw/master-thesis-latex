...
\todo[inline]{Improving the reliability of predictive process monitoring -- subsequence encoding}
...
\begin{table}
    ...
    \begin{tabular}{cclccccc}
        ...
        \hline
    \end{tabular}
    \caption{Prefixes encoded with SP-2. As $t$ progresses, more and more occurence of single-item subsequences are marked as occured. The alphabet is $I=\{a,b,c,d,e\}$. This example is taken from Shibata et al.  \cite{shibata2016bipartite}.}
