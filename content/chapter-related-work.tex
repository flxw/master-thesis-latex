...
\begin{figure}
    ...
    \caption[Network architecture used by Shibata et al.]{Network architecture used by Shibata et al. Illustration taken from~\cite{shibata2016bipartite}}
...
Also, we noted the contradiction between the findings of Klinkmüller et al. about training models on the complete history,
and the fact that many others authors use windowing.
