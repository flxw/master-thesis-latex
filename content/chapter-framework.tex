...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{gfx/individual-batching.png}
    \caption[Individual batch construction strategy]{Batch construction from a single sample. A batch is boxed in a blue rectangle, and its dimensions are written beside it.}
...
\autoref{fig:grouping-batching-example} illustrates how a grouping could look like.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{gfx/grouped-batching.png}
    \caption[Grouped batch construction strategy]{Batch construction by grouping samples. A batch is boxed in a blue rectangle, and its dimensions are written beside it.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{gfx/padded-batching.png}
    \caption[Padded batch construction strategy]{Batch construction from padded samples. Padding values are depicted by gray boxes.}
