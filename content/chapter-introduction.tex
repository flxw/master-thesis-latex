...
During reverse engineering, we uncovered widely divergent understandings of the batch structure of sequential training data input for neural networks. To contribute to a better understanding in this area, we include a comparison of four different batching strategies into the evaluation.
