...
While we reverse-engineered the architecture to the best of our knowledge, the original authors used the low-level Tensorflow training framework directly.
This could have enabled cues and optimizations which are not possible within Keras.\\
