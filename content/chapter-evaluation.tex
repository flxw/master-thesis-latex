...
Third, all models all produce accuracy curves that follow the same trend.
...
The reason for this accuracy can be found in \autoref{tab:dataset-characteristics} and \autoref{tab:batch-sizes} in \autoref{sec:methodology}.
