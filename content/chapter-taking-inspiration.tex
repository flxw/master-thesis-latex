...
Another difference is the dimensionality of the hidden layers: In contrast to Evermann et al. and Shibata et al., the size is not fixed or smaller than the output unit count $m$.
...
Said features and the corresponding architecture are henceforth referred to as PFS, illustrated in \autoref{fig:pfs-architecture}. The PFS feature vector has $l$ dimensions.
